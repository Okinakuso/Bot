...
if (message.content.startsWith(`${prefix}ching`) {
...
if (message.content.startsWith(`${prefix}pute`) {
...
if (message.content.startsWith(`${prefix}octogone`) {
...
if (message.content.startsWith(`${prefix}tera`) {
...
if (message.content.startsWith(`${prefix}rly`) {
...
if (message.content.startsWith(`${prefix}illya`) {
...
if (message.content.startsWith(`${prefix}xam`) {
...
if (message.content.startsWith(`${prefix}tezer`) {
...
if (message.content.startsWith(`${prefix}kaisa`) {
...
if (message.content.startsWith(`${prefix}bac`) {
